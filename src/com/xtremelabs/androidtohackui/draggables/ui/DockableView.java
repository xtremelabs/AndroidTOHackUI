...
public class DockableView extends DraggableView {
	...
	public DockableView(Context context) {
		super(context);
		init(context);
	}
	...
	public DockableView(Context context, AttributeSet attrs, int defStyle) {
	...
	public void setYOffset(float offset) {
		mYOffset = offset;
		setTop((mYOffset>0) ? (int)mYOffset : 0);
